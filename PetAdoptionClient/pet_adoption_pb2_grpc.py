...
class PetAdoptionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterPet = channel.unary_unary(
                ...
                response_deserializer=pet__adoption__pb2.RegistrationResponse.FromString,
        ...
        self.SearchPet = channel.unary_unary(
                ...
                response_deserializer=pet__adoption__pb2.PetList.FromString,
                _registered_method=True)
...
def add_PetAdoptionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RegisterPet': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=pet__adoption__pb2.RegistrationResponse.SerializeToString,
            ),
            'SearchPet': grpc.unary_unary_rpc_method_handler(
                    servicer.SearchPet,
                    request_deserializer=pet__adoption__pb2.SearchRequest.FromString,
                    response_serializer=pet__adoption__pb2.PetList.SerializeToString,
            ),
    }
...
class PetAdoption(object):
    ...
    def RegisterPet(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            pet__adoption__pb2.RegistrationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SearchPet(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            pet__adoption__pb2.PetList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
